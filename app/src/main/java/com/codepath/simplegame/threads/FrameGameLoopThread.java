...
import com.codepath.dropgame.DropGamePanel;
import com.codepath.dropgame.MainActivity;
import com.codepath.dropgame.VictoryActivity;
		...
		while (running) {
			...
			try {
				...
				synchronized (surfaceHolder) {
					...
					// update game state
					synchronized (gamePanel.getBugs()) {
